...
import { Archive, Bell, CheckCheck, CircleDot, CirclePause, Columns3, Folder, History, MessageSquare, Plus, Play, LoaderCircle, Settings2, SquarePen, UserRound, X } from "lucide-react";
import type { PilotTask } from "../core";
...
export default function App() {
  ...
  const refreshLabel = researching ? "正在推进" : researchQueued ? "推进已排队" : "推进";
